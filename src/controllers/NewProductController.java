...
Parent root = FXMLLoader.load(getClass().getResource("/views/AddCamtel.fxml"));
...
Parent root = FXMLLoader.load(getClass().getResource("/views/AddMTNB.fxml"));
        Scene scene = new Scene(root);
        Stage st = new Stage();
        st.setScene(scene);
        st.setResizable(false);
...
Parent root = FXMLLoader.load(getClass().getResource("/views/AddOrangeB.fxml"));
        Scene scene = new Scene(root);
        Stage st = new Stage();
        st.setScene(scene);
        st.setResizable(false);
